...
useEffect(()=>{
    ...
    return (
     ...
     <main className="main">
      ...
      <div class="card " style={{width: "40rem",backgroundColor:"black"}}>
  ...
  <div class="card-body">
    ...
    <a href="https://github.com/timhilehin1/Musica.git"><button class="contact-btn">Demo <AiOutlineArrowRight/></button></a>
  </div>
</div>
</div>
...
<div className=" mt-4  d-flex justify-content-center">
  ...
  <div class="card-body">
    ...
    <a href="https://timhilehin1.github.io/React_e-commerce-app/"><button class="contact-btn">Demo <AiOutlineArrowRight/></button></a>
  </div>
</div>
</div>
...
<div className=" mt-4 d-flex justify-content-center">
  ...
  <div class="card-body">
    ...
    <a href="https://timhilehin1.github.io/quiziccal-App/"><button class="contact-btn">Demo <AiOutlineArrowRight/></button></a>
  </div>
</div>
</div>
...
<div className=" mt-4  d-flex justify-content-center">
  ...
  <div class="card-body">
    ...
    <a href="https://timhilehin1.github.io/Game-website/"><button class="contact-btn">Demo <AiOutlineArrowRight/></button></a>
  </div>
</div>
</div>
